...
import com.mukund.frm.client.extra.PersonUtil;
import com.mukund.frm.client.ui.event.FilterEvent;
import com.mukund.frm.client.ui.event.SearchEvent;
...
public class PersonPanelView extends Composite implements Startable {
	...
	@UiField
	public SuggestBox nameSuggestBox;

	@UiField
	public DateTimePicker fromDateTimePicker;

	@UiField
	public DateTimePicker untilDateTimePicker;

	@UiField
	public TabListItem listTab;

	@UiField
	public TabListItem searchTab;

	@UiField
	public DataGrid<PersonDto> dataGrid1;

	@UiField
	public DataGrid<PersonDto> dataGrid2;

	@UiField
	public Pagination dataGridPagination1;

	@UiField
	public Pagination dataGridPagination2;

	@UiField
	public MultipleSelect foodMultipleSelect;
	...
	public boolean runTimerRefreshButton() {
	...
	public  void runTimerRefreshButtonExecutor() {
