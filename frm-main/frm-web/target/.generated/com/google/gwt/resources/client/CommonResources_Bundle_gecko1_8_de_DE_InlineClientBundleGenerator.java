...
public class CommonResources_Bundle_gecko1_8_de_DE_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_gecko1_8_de_DE_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_gecko1_8_de_DE_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GNJD51RCH{display:" + ("\\-moz-inline-box")  + ";position:" + ("relative")  + ";display:" + ("inline-block")  + ";}");
      }
