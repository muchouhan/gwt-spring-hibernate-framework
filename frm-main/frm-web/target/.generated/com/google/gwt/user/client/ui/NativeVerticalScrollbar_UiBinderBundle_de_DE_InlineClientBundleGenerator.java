...
public class NativeVerticalScrollbar_UiBinderBundle_de_DE_InlineClientBundleGenerator implements com.google.gwt.user.client.ui.NativeVerticalScrollbar.UiBinderBundle {
  private static NativeVerticalScrollbar_UiBinderBundle_de_DE_InlineClientBundleGenerator _instance0 = new NativeVerticalScrollbar_UiBinderBundle_de_DE_InlineClientBundleGenerator();
  private void nativeVerticalScrollbarUiInitializer() {
    nativeVerticalScrollbarUi = new com.google.gwt.user.client.ui.NativeVerticalScrollbar.UiStyle() {
      ...
      public String getText() {
        return (".GNJD51RCDI{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";direction:" + ("ltr")  + ";}.GNJD51RCCI{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";height:" + ("100%")  + ";width:" + ("100px")  + ";overflow-y:" + ("scroll")  + ";overflow-x:" + ("hidden")  + ";}");
      }
