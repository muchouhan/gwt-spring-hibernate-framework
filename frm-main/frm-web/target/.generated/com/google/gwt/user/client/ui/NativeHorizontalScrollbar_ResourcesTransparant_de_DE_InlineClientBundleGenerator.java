...
public class NativeHorizontalScrollbar_ResourcesTransparant_de_DE_InlineClientBundleGenerator implements com.google.gwt.user.client.ui.NativeHorizontalScrollbar.ResourcesTransparant {
  private static NativeHorizontalScrollbar_ResourcesTransparant_de_DE_InlineClientBundleGenerator _instance0 = new NativeHorizontalScrollbar_ResourcesTransparant_de_DE_InlineClientBundleGenerator();
  private void nativeHorizontalScrollbarStyleInitializer() {
    nativeHorizontalScrollbarStyle = new com.google.gwt.user.client.ui.NativeHorizontalScrollbar.Style() {
      ...
      public String getText() {
        return (".GNJD51RCOH{opacity:" + ("0.7")  + ";filter:" + ("alpha(opacity = 70)")  + ";-webkit-transition:" + ("opacity"+ " " +"350ms")  + ";-moz-transition:" + ("opacity"+ " " +"350ms")  + ";-o-transition:" + ("opacity"+ " " +"350ms")  + ";transition:" + ("opacity"+ " " +"350ms")  + ";}.GNJD51RCOH:hover{opacity:" + ("1")  + ";filter:" + ("alpha(opacity = 100)")  + ";}");
      }
