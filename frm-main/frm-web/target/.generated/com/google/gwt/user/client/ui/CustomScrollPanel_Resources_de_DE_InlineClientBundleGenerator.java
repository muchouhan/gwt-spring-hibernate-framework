...
public class CustomScrollPanel_Resources_de_DE_InlineClientBundleGenerator implements com.google.gwt.user.client.ui.CustomScrollPanel.Resources {
  private static CustomScrollPanel_Resources_de_DE_InlineClientBundleGenerator _instance0 = new CustomScrollPanel_Resources_de_DE_InlineClientBundleGenerator();
  private void customScrollPanelStyleInitializer() {
    customScrollPanelStyle = new com.google.gwt.user.client.ui.CustomScrollPanel.Style() {
      ...
      public String getText() {
        return (".GNJD51RCNH{background:" + ("#efefef")  + ";}");
      }
